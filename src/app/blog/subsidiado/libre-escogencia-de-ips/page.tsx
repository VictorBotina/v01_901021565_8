// src/app/blog/subsidiado/libre-escogencia-de-ips/page.tsx
...
const ARTICLE_ID = "yb6w8185t1fbcvfwdscqvl7v";
const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'http://localhost:9002';
const shareUrl = `${siteUrl}/blog/subsidiado/libre-escogencia-de-ips`;
...
export default async function LibreEscogenciaPage() {
  const article = await getArticle();
  if (!article) notFound();
